...
const EngineerProjects = () => {
  ...
  return (
    <div className="space-y-6" data-testid="engineer-projects-page">
      <h3 className="text-2xl font-bold uppercase tracking-tight text-slate-900">My Projects</h3>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <div>
              <Label className="text-xs font-medium uppercase tracking-wider">Progress (%)</Label>
              <Input
                type="number"
                min="0"
                max="100"
                ...
                onChange={(e) => setProgressData({ ...progressData, progress: parseFloat(e.target.value) })}
                className="mt-1 rounded-sm border-slate-300 bg-slate-50"
              />
            </div>
            <div>
              <Label className="text-xs font-medium uppercase tracking-wider">Notes</Label>
              <Textarea
            ...
            <Button onClick={handleUpdateProgress} data-testid="submit-progress-button" className="w-full bg-slate-900 rounded-sm btn-press">
              Update Progress
            </Button>
          </div>
        </DialogContent>
